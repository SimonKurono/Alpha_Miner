...
## Executive Summary
Evaluation run `f4_smoke_20260224` produced 10 factor result(s); 1 met promotion thresholds. Report includes 1 selected factor(s). Selected 1 promoted factor(s) from evaluation results for reporting.
...
{
  "lineage": {
    "evaluation_run_id": "f4_smoke_20260224",
    "factor_run_id": "f3_smoke_20260223",
    "hypothesis_run_id": null,
    "ingestion_run_id": "f1_smoke_s2_postfix_20260223"
  },
